        ...
        <div class="main">
            ...
            <div class="container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $x = (int)$_POST['tdew'];
                    $query1 = mysqli_query($conn, "SELECT * FROM ea where temperature = '$x'");
                    ...
                    <div><center>
                            ...
                            <ul class = "read-more-wrap">
                                ...
                                <li class = "read-more-target">Kc initial : <input type='text' value=" <?php echo $row5['initial'] ?>"/>    
                                    <?php $etcini = $eto * $row5['initial']; ?>
                                <li class = "read-more-target">ETc initial : <input type='text' value=" <?php echo $etcini ?>"/>
                                    <?php
                                    $cwrini = $etcini * $area;
                                    $cwrini = round($cwrini, 2);
                                    ?>
                                <li>Water requirement in L: <input type='text' value=" <?php echo $cwrini ?>"/>
                            </ul>
                            <br>
