                ...
                if (isset($_POST['submit'])) {
                    ...
                    <div><center>
                            ...
                            <ul class = "read-more-wrap">
                                ...
                                <li class = "read-more-target">Kc mid: <input type='text' value=" <?php echo $row5['mid'] ?>"/>    
                                    <?php $etcmid = $eto * $row5['mid']; ?>
                                <li class = "read-more-target">ETc mid : <input type='text' value=" <?php echo $etcmid ?>"/>
                                    <?php
                                    $cwrmid = $etcmid * $area;
                                    $cwrmid = round($cwrmid, 2);
                                    ?>
                                <li>Water requirement in L: <input type='text' value=" <?php echo $cwrmid ?>"/>
                            </ul>
                            <br>
