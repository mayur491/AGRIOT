                ...
                if (isset($_POST['submit'])) {
                    ...
                    <div><center>
                            ...
                            <ul class = "read-more-wrap">
                                ...
                                <li class = "read-more-target">Kc harvest : <input type='text' value=" <?php echo $row5['harvest'] ?>"/>    
                                    <?php $etcharvest = $eto * $row5['harvest']; ?>
                                <li class = "read-more-target">ETc harvest : <input type='text' value=" <?php echo $etcharvest ?>"/>
                                    <?php
                                    $cwrhar = $etcharvest * $area;
                                    $cwrhar = round($cwrhar, 2);
                                    ?>
                                <li>Water requirement in L: <input type='text' value=" <?php echo $cwrhar ?>"/>
                            </ul>
                            <br>
