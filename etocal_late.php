                ...
                if (isset($_POST['submit'])) {
                    ...
                    <div><center>
                            ...
                            <ul class = "read-more-wrap">
                                ...
                                <li class = "read-more-target">Kc late : <input type='text' value=" <?php echo $row5['late'] ?>"/>    
                                    <?php $etclate = $eto * $row5['late']; ?>
                                <li class = "read-more-target">ETc late : <input type='text' value=" <?php echo $etclate ?>"/>
                                    <?php
                                    $cwrlate = $etclate * $area;
                                    $cwrlate = round($cwrlate, 2);
                                    ?>
                                <li>Water requirement in L: <input type='text' value=" <?php echo $cwrlate ?>"/>
                            </ul>
                            <br>
